...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            #self.epsilon -= 0.05
            #self.epsilon = 1 / (self.tolerance * self.tolerance)
    ...
    def choose_action(self, state):
        ...
        if not self.learning:
            ...
            maxQ1 = self.get_maxQ(state)
            maxQ2 = []
            
            for i in self.Q[state]:
                if(self.Q[state][i]) == maxQ1:
                    maxQ2.append(i)
                    
            action = random.choice(maxQ2)
...
def run():
    ...
    #, learning=True, epsilon=1,alpha=0.02
    ...
    #, update_delay=0.01, log_metrics=True, optimized=True
